                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('user.profile') }}">
                        ...
                        <div class="form-group{{ $errors->has('privileges') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select name="privileges" id="role" class="form-control" disabled>
                        ...
                        <div class="form-group if-show{{ $errors->has('privileges') ? ' has-error' : '' }}" style="{{ $user->privileges != 'inputer' ? 'display:none' : '' }}">
                            <label for="uic" class="col-md-4 control-label">UIC</label>

                            <div class="col-md-6">
                                <select class="form-control" name="uic" disabled>
